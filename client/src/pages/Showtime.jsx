...
const Showtime = () => {
	...
	return (
		...
		<div className="flex min-h-screen flex-col gap-4 bg-primary-100 pb-8 sm:gap-8">
			<Navbar />
			<div className="mx-4 h-fit rounded-lg p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				{showtime.showtime ? (
					<>
						<ShowtimeDetails showtime={showtime} showDeleteBtn={true} fetchShowtime={fetchShowtime} />
						<div className="flex flex-col justify-between rounded-b-lg bg-primary-200 text-center text-lg drop-shadow-lg md:flex-row">
							...
							{!!selectedSeats.length && (
								<Link
									...
									className="flex items-center justify-center gap-2 rounded-b-lg bg-primary-500 px-4 py-1 font-semibold text-white hover:from-indigo-500 hover:to-blue-500 md:rounded-none md:rounded-br-lg"
								>
									<p>Purchase</p>
						...
						<div className="mx-auto mt-4 flex flex-col items-center rounded-lg bg-primary-200 p-4 text-center drop-shadow-lg">
						...
						{auth.role === 'admin' && (
							<>
								...
								<div className="mt-2 flex gap-2 rounded-md bg-primary-200 p-4">
								...
								<div
									className={`mt-4 grid max-h-screen w-full overflow-auto rounded-md bg-primary-200`}
									style={{
