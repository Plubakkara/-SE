...
const Search = () => {
	...
	return (
		<div style={{ backgroundColor: '#FEFDED' }} className="flex min-h-screen flex-col gap-4 pb-8 text-gray-900 sm:gap-8">
			<Navbar />
			<div className="mx-4 flex h-fit flex-col gap-2 rounded-lg bg-primary-200 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				<h2 className="text-3xl font-bold text-gray-900">Search Showtimes</h2>
				<div className="flex flex-col gap-2 rounded-md bg-primary-300 p-4 transition-all duration-500 ease-in-out">
				...
				<div className="flex items-end">
					...
					<div className="flex flex-wrap items-center gap-2 px-1">
						<button
							className="flex w-fit items-center justify-center gap-1 rounded bg-primary-500 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400 md:min-w-fit"
						...
						<button
							className="flex w-fit items-center justify-center gap-1 rounded bg-primary-50 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-red-600 hover:to-rose-500 disabled:from-slate-500 disabled:to-slate-400 md:min-w-fit"
				...
				<div
					className={`mb-4 grid max-h-screen overflow-auto rounded-md bg-primary-300`}
					style={{ gridTemplateColumns: '34px repeat(7, minmax(max-content, 1fr)) 104px' }}
				>
					<p className="sticky top-0 flex items-center justify-center rounded-tl-md bg-primary-500 text-center text-xl font-semibold text-white">
						<input
							type="checkbox"
							className="h-6 w-6"
							checked={isCheckAll}
					...
					<button
						className="sticky top-0 flex justify-center bg-primary-500 hover:from-gray-700 hover:to-gray-600 px-2 py-1 text-center text-xl font-semibold text-white"
						onClick={() => {
					...
					<p className="sticky top-0 z-[1] flex items-center justify-center gap-2 rounded-tr-md bg-primary-500 px-2 py-1 text-center text-xl font-semibold text-white">
								...
								<Fragment key={index}>
									<div
										className={`flex items-center justify-center border-t-2 border-indigo-200 ${
											isCheckedRow && 'border-white bg-red-200 text-blue-800'
										}`}
									>
										<input
											id={showtime._id}
									...
									<button
										className="flex items-center justify-center gap-2 bg-primary-300 px-2 py-1 text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
