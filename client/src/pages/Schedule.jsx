		...
		<div style={{ backgroundColor: '#FEFDED' }} className="flex min-h-screen flex-col gap-4 pb-8 text-gray-900 sm:gap-8">
			...
			{selectedCinemaIndex !== null &&
				(cinemas[selectedCinemaIndex]?.theaters?.length ? (
					<div className="mx-4 flex flex-col gap-2 rounded-lg bg-primary-200 p-4 drop-shadow-xl sm:mx-8 sm:gap-4 sm:p-6">
						<h2 className="text-3xl font-bold text-gray-900">Schedule</h2>
						<DateSelector selectedDate={selectedDate} setSelectedDate={setSelectedDate} />
						{auth.role === 'admin' && (
							<form
								className="flex flex-col lg:flex-row gap-4 rounded-md bg-primary-300 p-4"
