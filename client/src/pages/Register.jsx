...
const Register = () => {
	...
	return (
		<div style={{ backgroundColor: '#FEFDED' }} className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-primary-400 p-4 shadow-xl">
				<div>
				...
				<form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
					...
					<div>
						...
						<button
							type="submit"
							className="mt-4 w-full rounded-md bg-primary-500 py-2 px-4 font-medium text-white drop-shadow-md hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:from-slate-500 disabled:to-slate-400"
