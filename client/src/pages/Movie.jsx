...
const Movie = () => {
	...
	return (
		<div style={{ backgroundColor: '#FEFDED' }} className="flex min-h-screen flex-col gap-4 pb-8 text-gray-900 sm:gap-8">
			<Navbar />
			<div className="mx-4 flex h-fit flex-col gap-4 rounded-md bg-primary-200 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				<h2 className="text-3xl font-bold text-gray-900">Movie Lists</h2>
				<form
					onSubmit={handleSubmit(onAddMovie)}
					className="flex flex-col items-stretch justify-end gap-x-4 gap-y-2 rounded-md bg-primary-300 p-4 drop-shadow-md lg:flex-row"
				>
					...
					<div className="flex w-full flex-col gap-4 lg:w-auto lg:flex-row">
						...
						<button
							className="w-full min-w-fit items-center rounded-md bg-primary-500 px-2 py-1 text-center font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-500 disabled:from-slate-500 disabled:to-slate-400 lg:w-24 xl:w-32 xl:text-xl"
							type="submit"
