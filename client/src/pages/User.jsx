	...
	return (
		<div style={{ backgroundColor: '#FEFDED' }} className="flex min-h-screen flex-col gap-4 pb-8 text-gray-900 sm:gap-8">
			...
			<div className="mx-4 flex h-fit flex-col gap-2 rounded-lg bg-primary-200 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				...
				<div
					className={`mt-2 grid max-h-[60vh] overflow-auto rounded-md bg-primary-300 to-white`}
					style={{ gridTemplateColumns: 'repeat(3, minmax(max-content, 1fr)) max-content max-content' }}
				>
					<p className="sticky top-0 bg-primary-500 to-gray-700 px-2 py-1 text-center text-xl font-semibold text-white">
						Username
					</p>
					<p className="sticky top-0 bg-primary-500 to-gray-700 px-2 py-1 text-center text-xl font-semibold text-white">
						Email
					...
					<p className="sticky top-0 bg-primary-500 px-2 py-1 text-center text-xl font-semibold text-white">
						Action
					</p>
					{users
							...
							return (
								<Fragment key={index}>
									...
									<div className="flex gap-2 border-t-2 border-indigo-200 px-2 py-1">
										{user.role === 'user' && (
											<button
												className="flex w-[115px] items-center justify-center gap-1 rounded bg-primary-500 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
										...
										<button
											className="flex w-[115px] items-center justify-center gap-1 rounded bg-primary-50 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-red-600 hover:to-rose-500 disabled:from-slate-500 disabled:to-slate-400"
								...
								{tickets.map((ticket, index) => {
									return (
										<div className="flex flex-col" key={index}>
											...
											<div className="flex h-full flex-col justify-between rounded-b-lg bg-primary-300 text-center text-lg drop-shadow-lg md:flex-row">
