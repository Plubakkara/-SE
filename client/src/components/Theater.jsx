	...
	return (
		<div className="flex flex-col">
			<div className="flex md:justify-between">
				<h3
					className={`flex w-fit items-center rounded-tl-2xl bg-primary-500 px-6 py-0.5 text-2xl font-bold text-white md:rounded-t-2xl md:px-8 ${
				...
				{auth.role === 'admin' && (
					<div className="flex w-fit flex-col gap-x-3 rounded-tr-2xl bg-primary-500 px-4 py-0.5 font-semibold text-white md:flex-row md:gap-x-6 md:rounded-t-2xl md:text-lg md:font-bold">
			...
			<div className="flex flex-col gap-4 rounded-b-md rounded-tr-md bg-primary-400 py-4 md:rounded-tr-none">
				{auth.role === 'admin' && (
					<>
						<form
						...
						>
							...
							<button
								...
								className="whitespace-nowrap rounded-md bg-primary-500 px-2 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
								type="submit"
							>
								ADD +
							</button>
