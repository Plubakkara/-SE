		...
		<>
			...
			<div className="mx-4 h-fit rounded-md bg-primary-200 text-gray-900 drop-shadow-md sm:mx-8">
				<div className="flex flex-col gap-6 p-4 sm:p-6">
					...
					<div className="flex flex-col gap-4 rounded-md bg-primary-400 to-white py-4">
							...
							{filteredTheaters.map((theater, index) => {
								return (
									...
									>
										{filteredTheaters[index - 1]?.cinema.name !==
											filteredTheaters[index].cinema.name && (
											<div className="rounded-t-md bg-primary-300 px-2 py-1.5 text-center text-2xl font-semibold text-white sm:py-2">
