...
const DateSelector = ({ selectedDate, setSelectedDate }) => {
		...
		return (
			<button
				...
				className={`flex min-w-[48px] flex-col items-center justify-center rounded p-1 font-semibold ${
					isThisDate
						? 'bg-gradient-to-br from-red-400 to-red-400 text-white'
						: isToday
						? 'bg-gradient-to-br from-red-100 to-red-100 ring-2 ring-inset ring-red-800 hover:from-white hover:to-white'
						: isPast(date)
						? 'bg-gradient-to-br from-gray-600 to-gray-500 text-white hover:from-gray-500 hover:to-gray-400'
						: 'bg-gradient-to-br from-red-100 to-white hover:from-white hover:to-white'
				}`}
				onClick={() => {
	...
	return (
		<div className="flex flex-col gap-2">
			<div style={{ backgroundColor: '#A1C398' }} className="relative flex items-stretch justify-between gap-2 rounded-md p-2 font-semibold text-white">
				...
				{isEditing ? (
					...
					<div
						className="flex w-full items-center justify-center rounded text-center text-xl hover:bg-red-400 sm:text-2xl"
						onClick={() => {
							SetIsEditing(true)
						}}
					>
				...
				<div className="flex items-center justify-between gap-2">
					...
					<button
						title="Go to today"
						className="rounded px-1 hover:bg-red-400"
						onClick={handleToday}
					>
