	...
	return (
		<>
			{showDeleteBtn && auth.role === 'admin' && (
				<div className="mb-4 flex justify-end gap-2">
					...
					{showtime.isRelease && (
						<button
							title="Edit cinema name"
							className="flex w-fit items-center gap-1 rounded-md bg-primary-500  py-1 pl-2 pr-1.5 text-sm font-medium text-white disabled:from-slate-500 disabled:to-slate-400"
					...
					<button
						className="flex w-fit items-center gap-1 rounded-md bg-primary-50 py-1 pl-2 pr-1.5 text-sm font-medium text-white disabled:from-slate-500 disabled:to-slate-400"
			...
			<div className="flex justify-between">
				<div className="flex flex-col justify-center rounded-tl-lg bg-primary-500 px-4 py-0.5 text-center font-bold text-white sm:px-8">
					<p className="text-sm">Theater</p>
					<p className="text-3xl">{showtime?.theater?.number}</p>
				</div>
				<div className="flex w-fit grow items-center justify-center rounded-tr-lg bg-primary-300 px-4 py-0.5 text-center text-xl font-bold text-white sm:text-3xl">
			...
			<div className="flex flex-col md:flex-row">
				<div className="flex grow flex-col gap-4 bg-primary-200 py-2 drop-shadow-lg sm:py-4">
				...
				<div className="flex flex-col">
					<div className="flex h-full min-w-max flex-col items-center justify-center gap-y-1 bg-primary-500 py-2 text-center text-primary-100 font-semibold drop-shadow-lg sm:py-4 sm:text-2xl md:items-start">
						...
						<p className="mx-4 bg-primary-100 bg-clip-text text-4xl font-bold text-transparent sm:text-5xl">
							{showtime?.showtime &&
